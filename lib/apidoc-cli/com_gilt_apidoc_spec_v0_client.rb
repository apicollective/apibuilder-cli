...
# apidoc:0.9.17 http://localhost:9000/gilt/apidoc-spec/0.9.16/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              USER_AGENT = 'apidoc:0.9.17 http://localhost:9000/gilt/apidoc-spec/0.9.16/ruby_client' unless defined?(Constants::USER_AGENT)
          ...
          module Models
            ...
            class Body
              ...
              def initialize(incoming={})
                ...
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(x)))
              end
            ...
            class Enum
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @values = HttpClient::Preconditions.assert_class('values', opts.delete(:values), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::EnumValue) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::EnumValue.new(x)) }
              end
            ...
            class Import
              ...
              def initialize(incoming={})
                ...
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Organization) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Organization.new(x))
                @application = (x = opts.delete(:application); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Application) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Application.new(x))
                @version = HttpClient::Preconditions.assert_class('version', opts.delete(:version), String)
            ...
            class Info
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @license = (x = opts.delete(:license); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::License) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::License.new(x)))
                @contact = (x = opts.delete(:contact); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Contact) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Contact.new(x)))
              end
            ...
            class Model
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @fields = HttpClient::Preconditions.assert_class('fields', opts.delete(:fields), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Field) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Field.new(x)) }
              end
            ...
            class Operation
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @method = (x = opts.delete(:method); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Method) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Method.apply(x))
                @path = HttpClient::Preconditions.assert_class('path', opts.delete(:path), String)
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @body = (x = opts.delete(:body); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Body) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Body.new(x)))
                @parameters = HttpClient::Preconditions.assert_class('parameters', (x = opts.delete(:parameters); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Parameter) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Parameter.new(x)) }
                @responses = HttpClient::Preconditions.assert_class('responses', (x = opts.delete(:responses); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Response) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Response.new(x)) }
              end
            ...
            class Parameter
              ...
              def initialize(incoming={})
                ...
                @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
                @type = HttpClient::Preconditions.assert_class('type', opts.delete(:type), String)
                @location = (x = opts.delete(:location); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::ParameterLocation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::ParameterLocation.apply(x))
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @required = HttpClient::Preconditions.assert_boolean('required', opts.delete(:required))
                @default = (x = opts.delete(:default); x.nil? ? nil : HttpClient::Preconditions.assert_class('default', x, String))
            ...
            class Resource
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @operations = HttpClient::Preconditions.assert_class('operations', opts.delete(:operations), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Operation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Operation.new(x)) }
              end
            ...
            class Response
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @code = (x = opts.delete(:code); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::ResponseCode) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::ResponseCode.from_json(x))
                @type = HttpClient::Preconditions.assert_class('type', opts.delete(:type), String)
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(x)))
              end
            ...
            class Service
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @apidoc = (x = opts.delete(:apidoc); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Apidoc) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Apidoc.new(x))
                @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Organization) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Organization.new(x))
                @application = (x = opts.delete(:application); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Application) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Application.new(x))
                @namespace = HttpClient::Preconditions.assert_class('namespace', opts.delete(:namespace), String)
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @info = (x = opts.delete(:info); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Info) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Info.new(x))
                @headers = HttpClient::Preconditions.assert_class('headers', (x = opts.delete(:headers); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Header) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Header.new(x)) }
                @imports = HttpClient::Preconditions.assert_class('imports', (x = opts.delete(:imports); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Import) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Import.new(x)) }
                @enums = HttpClient::Preconditions.assert_class('enums', (x = opts.delete(:enums); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Enum) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Enum.new(x)) }
                @unions = HttpClient::Preconditions.assert_class('unions', (x = opts.delete(:unions); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Union) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Union.new(x)) }
                @models = HttpClient::Preconditions.assert_class('models', (x = opts.delete(:models); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Model) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Model.new(x)) }
                @resources = HttpClient::Preconditions.assert_class('resources', (x = opts.delete(:resources); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Resource) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Resource.new(x)) }
              end
            ...
            class Union
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @types = HttpClient::Preconditions.assert_class('types', opts.delete(:types), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::UnionType) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::UnionType.new(x)) }
              end
