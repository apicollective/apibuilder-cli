...
# apidoc:0.9.2 http://localhost:9000/gilt/apidoc-spec/0.9.3/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              USER_AGENT = 'apidoc:0.9.2 http://localhost:9000/gilt/apidoc-spec/0.9.3/ruby_client' unless defined?(Constants::USER_AGENT)
          ...
          module Models
            ...
            class Body
              ...
              def initialize(incoming={})
                ...
                @deprecation = HttpClient::Preconditions.assert_class_or_nil('deprecation', opts[:deprecation].nil? ? nil : (opts[:deprecation].is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? opts.delete(:deprecation) : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(opts.delete(:deprecation))), ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation)
              end
              ...
              def to_hash
                {
                  ...
                  :description => description,
                  :deprecation => deprecation.nil? ? nil : deprecation.to_hash,
                  :values => values.nil? ? nil : values.map(&:to_hash)
                }
              end
              ...
              def to_hash
                {
                  ...
                  :description => description,
                  :deprecation => deprecation.nil? ? nil : deprecation.to_hash,
                  :fields => fields.nil? ? nil : fields.map(&:to_hash)
                }
              end
            ...
            class Operation
              ...
              def initialize(incoming={})
                ...
                @parameters = HttpClient::Preconditions.assert_class('parameters', opts.delete(:parameters) || [], Array).map { |el| el.nil? ? nil : (el.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Parameter) ? el : ::Com::Gilt::Apidoc::Spec::V0::Models::Parameter.new(el)) }
                @responses = HttpClient::Preconditions.assert_class('responses', opts.delete(:responses) || [], Array).map { |el| el.nil? ? nil : (el.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Response) ? el : ::Com::Gilt::Apidoc::Spec::V0::Models::Response.new(el)) }
              end
              ...
              def to_hash
                {
                  ...
                  :parameters => parameters.nil? ? nil : parameters.map(&:to_hash),
                  :responses => responses.nil? ? nil : responses.map(&:to_hash)
                }
              end
              ...
              def to_hash
                {
                  ...
                  :description => description,
                  :deprecation => deprecation.nil? ? nil : deprecation.to_hash,
                  :operations => operations.nil? ? nil : operations.map(&:to_hash)
                }
              end
            ...
            class Response
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @code = HttpClient::Preconditions.assert_class('code', opts[:code].nil? ? nil : (opts[:code].is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::ResponseCode) ? opts.delete(:code) : ::Com::Gilt::Apidoc::Spec::V0::Models::ResponseCode.from_json(opts.delete(:code))), ::Com::Gilt::Apidoc::Spec::V0::Models::ResponseCode)
                @type = HttpClient::Preconditions.assert_class('type', opts.delete(:type), String)
                @description = HttpClient::Preconditions.assert_class_or_nil('description', opts.delete(:description), String)
                @deprecation = HttpClient::Preconditions.assert_class_or_nil('deprecation', opts[:deprecation].nil? ? nil : (opts[:deprecation].is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation) ? opts.delete(:deprecation) : ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation.new(opts.delete(:deprecation))), ::Com::Gilt::Apidoc::Spec::V0::Models::Deprecation)
              end
              ...
              def to_hash
                {
                  :code => code.nil? ? nil : code.to_hash,
                  :type => type,
                  :description => description,
                  :deprecation => deprecation.nil? ? nil : deprecation.to_hash
                }
              ...
              def to_hash
                {
                  ...
                  :base_url => base_url,
                  :description => description,
                  :headers => headers.nil? ? nil : headers.map(&:to_hash),
                  :imports => imports.nil? ? nil : imports.map(&:to_hash),
                  :enums => enums.nil? ? nil : enums.map(&:to_hash),
                  :unions => unions.nil? ? nil : unions.map(&:to_hash),
                  :models => models.nil? ? nil : models.map(&:to_hash),
                  :resources => resources.nil? ? nil : resources.map(&:to_hash)
                }
              end
              ...
              def to_hash
                {
                  ...
                  :description => description,
                  :deprecation => deprecation.nil? ? nil : deprecation.to_hash,
                  :types => types.nil? ? nil : types.map(&:to_hash)
                }
              end
