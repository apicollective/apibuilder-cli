...
# apidoc:0.11.36 http://www.apidoc.me/bryzek/apidoc-api/0.11.26/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              BASE_URL = 'http://api.apidoc.me' unless defined?(Constants::BASE_URL)
              NAMESPACE = 'com.bryzek.apidoc.api.v0' unless defined?(Constants::NAMESPACE)
              USER_AGENT = 'apidoc:0.11.36 http://www.apidoc.me/bryzek/apidoc-api/0.11.26/ruby_client' unless defined?(Constants::USER_AGENT)
            ...
            def attributes
              @attributes ||= ::Com::Bryzek::Apidoc::Api::V0::Clients::Attributes.new(self)
            end
            ...
            def generator_with_services
              @generator_with_services ||= ::Com::Bryzek::Apidoc::Api::V0::Clients::GeneratorWithServices.new(self)
            end
          ...
          module Clients
            ...
            class Attributes
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Bryzek::Apidoc::Api::V0::Models::Attribute.new(x) }
              end
              ...
              def get_by_name(name)
                ...
                ::Com::Bryzek::Apidoc::Api::V0::Models::Attribute.new(r)
              end

              # Create a new attribute.
              def post(attribute_form)
                HttpClient::Preconditions.assert_class('attribute_form', attribute_form, ::Com::Bryzek::Apidoc::Api::V0::Models::AttributeForm)
            ...
            class GeneratorWithServices
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Bryzek::Apidoc::Api::V0::Models::GeneratorWithService.new(x) }
              end

              def get_by_key(key)
                HttpClient::Preconditions.assert_class('key', key, String)
                r = @client.request("/generators/#{CGI.escape(key)}").get
                ::Com::Bryzek::Apidoc::Api::V0::Models::GeneratorWithService.new(r)
              end
            ...
            class Organizations
              ...
              def get_attributes_by_key(key, incoming={})
                ...
                r.map { |x| ::Com::Bryzek::Apidoc::Api::V0::Models::AttributeValue.new(x) }
              end
              ...
              def get_attributes_by_key_and_name(key, name)
                ...
                ::Com::Bryzek::Apidoc::Api::V0::Models::AttributeValue.new(r)
              end
              ...
              def put_attributes_by_key_and_name(key, name, attribute_value_form)
                HttpClient::Preconditions.assert_class('key', key, String)
                HttpClient::Preconditions.assert_class('name', name, String)
                HttpClient::Preconditions.assert_class('attribute_value_form', attribute_value_form, ::Com::Bryzek::Apidoc::Api::V0::Models::AttributeValueForm)
            ...
            class Subscriptions
              ...
              def get(incoming={})
                ...
                query = {
                  ...
                  :user_guid => (x = opts.delete(:user_guid); x.nil? ? nil : HttpClient::Preconditions.assert_class('user_guid', HttpClient::Helper.to_uuid(x), String)),
                  :publication => (x = opts.delete(:publication); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Api::V0::Models::Publication) ? x : ::Com::Bryzek::Apidoc::Api::V0::Models::Publication.apply(x)).value),
                  :limit => HttpClient::Preconditions.assert_class('limit', (x = opts.delete(:limit); x.nil? ? 25 : x), Integer),
                  :offset => HttpClient::Preconditions.assert_class('offset', (x = opts.delete(:offset); x.nil? ? 0 : x), Integer)
                }.delete_if { |k, v| v.nil? }
          ...
          module Models
            ...
            class Diff
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                HttpClient::Preconditions.require_keys(opts, [:name], 'Diff')
            ...
            class ItemDetail
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                HttpClient::Preconditions.require_keys(opts, [:name], 'ItemDetail')
                @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
              end
            ...
            class OriginalType
              ...
              def OriginalType.ALL
                @@all ||= [OriginalType.api_json, OriginalType.avro_idl, OriginalType.service_json, OriginalType.swagger_json]
              end
            ...
            class Application
              ...
              def initialize(incoming={})
                ...
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Bryzek::Apidoc::Common::V0::Models::Reference) ? x : ::Com::Bryzek::Apidoc::Common::V0::Models::Reference.new(x))
                @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
                ...
                @audit = (x = opts.delete(:audit); x.is_a?(::Com::Bryzek::Apidoc::Common::V0::Models::Audit) ? x : ::Com::Bryzek::Apidoc::Common::V0::Models::Audit.new(x))
              end
            ...
            class AttributeValue
              ...
              def initialize(incoming={})
                ...
                @guid = HttpClient::Preconditions.assert_class('guid', HttpClient::Helper.to_uuid(opts.delete(:guid)), String)
                @attribute = (x = opts.delete(:attribute); x.is_a?(::Com::Bryzek::Apidoc::Api::V0::Models::AttributeSummary) ? x : ::Com::Bryzek::Apidoc::Api::V0::Models::AttributeSummary.new(x))
            ...
            class Change
              ...
              def initialize(incoming={})
                ...
                @guid = HttpClient::Preconditions.assert_class('guid', HttpClient::Helper.to_uuid(opts.delete(:guid)), String)
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Bryzek::Apidoc::Common::V0::Models::Reference) ? x : ::Com::Bryzek::Apidoc::Common::V0::Models::Reference.new(x))
                @application = (x = opts.delete(:application); x.is_a?(::Com::Bryzek::Apidoc::Common::V0::Models::Reference) ? x : ::Com::Bryzek::Apidoc::Common::V0::Models::Reference.new(x))
            ...
            class Code
              ...
              def initialize(incoming={})
                ...
                @generator = (x = opts.delete(:generator); x.is_a?(::Com::Bryzek::Apidoc::Api::V0::Models::GeneratorWithService) ? x : ::Com::Bryzek::Apidoc::Api::V0::Models::GeneratorWithService.new(x))
            ...
            class GeneratorWithService
              ...
              def initialize(incoming={})
                ...
                @service = (x = opts.delete(:service); x.is_a?(::Com::Bryzek::Apidoc::Api::V0::Models::GeneratorService) ? x : ::Com::Bryzek::Apidoc::Api::V0::Models::GeneratorService.new(x))
                @generator = (x = opts.delete(:generator); x.is_a?(::Com::Bryzek::Apidoc::Generator::V0::Models::Generator) ? x : ::Com::Bryzek::Apidoc::Generator::V0::Models::Generator.new(x))
              end
            ...
            class OrganizationForm
              ...
              def initialize(incoming={})
                ...
                @key = (x = opts.delete(:key); x.nil? ? nil : HttpClient::Preconditions.assert_class('key', x, String))
                @namespace = HttpClient::Preconditions.assert_class('namespace', opts.delete(:namespace), String)
                @visibility = (x = (x = opts.delete(:visibility); x.nil? ? "organization" : x); x.is_a?(::Com::Bryzek::Apidoc::Api::V0::Models::Visibility) ? x : ::Com::Bryzek::Apidoc::Api::V0::Models::Visibility.apply(x))
            ...
            class PasswordResetSuccess
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                HttpClient::Preconditions.require_keys(opts, [:user_guid], 'PasswordResetSuccess')
