...
# apidoc:0.8.21 http://localhost:9000/gilt/apidoc-api/0.8.18/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              USER_AGENT = 'apidoc:0.8.21 http://localhost:9000/gilt/apidoc-api/0.8.18/ruby_client' unless defined?(Constants::USER_AGENT)
              VERSION = '0.8.18' unless defined?(Constants::VERSION)
          ...
          module Models
            ...
            class OriginalType
              ...
              def OriginalType.ALL
                @@all ||= [OriginalType.api_json, OriginalType.avro_idl]
              end
            ...
            class Organization
              ...
              def initialize(incoming={})
                ...
                @visibility = HttpClient::Preconditions.assert_class('visibility', opts[:visibility].nil? ? nil : (opts[:visibility].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? opts.delete(:visibility) : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(opts.delete(:visibility))), ::Com::Gilt::Apidoc::Api::V0::Models::Visibility)
                @domains = (opts.delete(:domains) || []).map { |el| el.nil? ? nil : (el.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Domain) ? el : ::Com::Gilt::Apidoc::Api::V0::Models::Domain.new(el)) }
              end
