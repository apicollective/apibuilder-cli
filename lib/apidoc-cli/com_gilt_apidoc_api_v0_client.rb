...
# apidoc:0.9.17 http://localhost:9000/gilt/apidoc-api/0.9.16/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              USER_AGENT = 'apidoc:0.9.17 http://localhost:9000/gilt/apidoc-api/0.9.16/ruby_client' unless defined?(Constants::USER_AGENT)
              VERSION = '0.9.16' unless defined?(Constants::VERSION)
            ...
            def changes
              @changes ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Changes.new(self)
            end
            ...
            def com_gilt_apidoc_generator_v0_models_generators
              @com_gilt_apidoc_generator_v0_models_generators ||= ::Com::Gilt::Apidoc::Api::V0::Clients::ComGiltApidocGeneratorV0ModelsGenerators.new(self)
            end
            ...
            def generator_services
              @generator_services ||= ::Com::Gilt::Apidoc::Api::V0::Clients::GeneratorServices.new(self)
            end
            ...
            def items
              @items ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Items.new(self)
            end
          ...
          module Clients
            ...
            class Applications
              ...
              def get_by_org_key(org_key, incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Application.new(x) }
              end
              ...
              def post_by_org_key(org_key, application_form)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Application.new(r)
              end
              ...
              def delete_by_org_key_and_application_key(org_key, application_key)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(r)
              end
            ...
            class Changes
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Change.new(x) }
              end
            ...
            class Code
              ...
              def get_by_org_key_and_application_key_and_version_and_generator_key(org_key, application_key, version, generator_key)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Code.new(r)
              end

            end

            class ComGiltApidocGeneratorV0ModelsGenerators
              ...
              def get_generators(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Generator::V0::Models::Generator.new(x) }
              end

              def get_generators_by_key(key)
                HttpClient::Preconditions.assert_class('key', key, String)
                r = @client.request("/generators/#{CGI.escape(key)}").get
                ::Com::Gilt::Apidoc::Generator::V0::Models::Generator.new(r)
              end
            ...
            class Domains
              ...
              def post_by_org_key(org_key, domain)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Domain.new(r)
              end
            ...
            class GeneratorServices
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::GeneratorService.new(x) }
              end

              def get_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                r = @client.request("/generator_services/#{guid}").get
                ::Com::Gilt::Apidoc::Api::V0::Models::GeneratorService.new(r)
              end

              def post(generator_service_form)
                HttpClient::Preconditions.assert_class('generator_service_form', generator_service_form, ::Com::Gilt::Apidoc::Api::V0::Models::GeneratorServiceForm)
            ...
            class Healthchecks
              ...
              def get_internal_and_healthcheck
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Healthcheck.new(r)
              end

              def get_internal_and_migrate
                r = @client.request("/_internal_/migrate").get
                r.inject({}) { |hash, x| hash[x[0]] = x[1].nil? ? nil : ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(x[1]); hash }
              end
            ...
            class Items
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Item.new(x) }
              end

              def get_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                r = @client.request("/items/#{guid}").get
                ::Com::Gilt::Apidoc::Api::V0::Models::Item.new(r)
              end
            ...
            class Memberships
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Membership.new(x) }
              end

              def get_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                r = @client.request("/memberships/#{guid}").get
                ::Com::Gilt::Apidoc::Api::V0::Models::Membership.new(r)
              end
            ...
            class MembershipRequests
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::MembershipRequest.new(x) }
              end
              ...
              def post(hash)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::MembershipRequest.new(r)
              end
            ...
            class Organizations
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(x) }
              end
              ...
              def get_by_key(key)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(r)
              end
            ...
            class PasswordResets
              ...
              def post(password_reset)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::PasswordResetSuccess.new(r)
              end
            ...
            class Subscriptions
              ...
              def get(incoming={})
                ...
                query = {
                  ...
                  :user_guid => (x = opts.delete(:user_guid); x.nil? ? nil : HttpClient::Preconditions.assert_class('user_guid', HttpClient::Helper.to_uuid(x), String)),
                  :publication => (x = opts.delete(:publication); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Publication) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Publication.apply(x))),
                  :limit => HttpClient::Preconditions.assert_class('limit', (x = opts.delete(:limit); x.nil? ? 25 : x), Integer),
                  :offset => HttpClient::Preconditions.assert_class('offset', (x = opts.delete(:offset); x.nil? ? 0 : x), Integer)
                }.delete_if { |k, v| v.nil? }
                r = @client.request("/subscriptions").with_query(query).get
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Subscription.new(x) }
              end
              ...
              def get_by_guid(guid)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Subscription.new(r)
              end
            ...
            class Tokens
              ...
              def get_users_by_user_guid(user_guid, incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Token.new(x) }
              end
              ...
              def get_cleartext_by_guid(guid)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::CleartextToken.new(r)
              end
              ...
              def post(token_form)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Token.new(r)
              end
            ...
            class Users
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::User.new(x) }
              end
              ...
              def get_by_guid(guid)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::User.new(r)
              end
            ...
            class Validations
              ...
              def post(value)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Validation.new(r)
              end
            ...
            class Versions
              ...
              def get_by_org_key_and_application_key(org_key, application_key, incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Version.new(x) }
              end
              ...
              def get_by_org_key_and_application_key_and_version(org_key, application_key, version)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Version.new(r)
              end
            ...
            class Watches
              ...
              def get(incoming={})
                ...
                r.map { |x| ::Com::Gilt::Apidoc::Api::V0::Models::Watch.new(x) }
              end
              ...
              def get_by_guid(guid)
                ...
                ::Com::Gilt::Apidoc::Api::V0::Models::Watch.new(r)
              end
          ...
          module Models
            ...
            class Application
              ...
              def initialize(incoming={})
                ...
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Reference) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Reference.new(x))
                @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
                @key = HttpClient::Preconditions.assert_class('key', opts.delete(:key), String)
                @visibility = (x = opts.delete(:visibility); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(x))
            ...
            class Change
              ...
              def initialize(incoming={})
                ...
                @guid = HttpClient::Preconditions.assert_class('guid', HttpClient::Helper.to_uuid(opts.delete(:guid)), String)
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Reference) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Reference.new(x))
                @application = (x = opts.delete(:application); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Reference) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Reference.new(x))
            ...
            class Code
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @generator = (x = opts.delete(:generator); x.is_a?(::Com::Gilt::Apidoc::Generator::V0::Models::Generator) ? x : ::Com::Gilt::Apidoc::Generator::V0::Models::Generator.new(x))
            ...
            class Item
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @guid = HttpClient::Preconditions.assert_class('guid', HttpClient::Helper.to_uuid(opts.delete(:guid)), String)
                @detail = (x = opts.delete(:detail); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::ItemDetail) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::ItemDetail.from_json(x))
            ...
            class Membership
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @guid = HttpClient::Preconditions.assert_class('guid', HttpClient::Helper.to_uuid(opts.delete(:guid)), String)
                @user = (x = opts.delete(:user); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::User) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::User.new(x))
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Organization) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(x))
            ...
            class Organization
              ...
              def initialize(incoming={})
                ...
                @visibility = (x = opts.delete(:visibility); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(x))
                @domains = HttpClient::Preconditions.assert_class('domains', (x = opts.delete(:domains); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Domain) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Domain.new(x)) }
                @audit = (x = opts.delete(:audit); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Audit) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Audit.new(x))
              end
            ...
            class OrganizationForm
              ...
              def initialize(incoming={})
                ...
                @key = (x = opts.delete(:key); x.nil? ? nil : HttpClient::Preconditions.assert_class('key', x, String))
                @namespace = HttpClient::Preconditions.assert_class('namespace', opts.delete(:namespace), String)
                @visibility = (x = (x = opts.delete(:visibility); x.nil? ? Visibility.apply("organization") : x); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(x))
            ...
            class Original
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @type = (x = opts.delete(:type); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::OriginalType) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::OriginalType.apply(x))
            ...
            class OriginalForm
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @type = (x = opts.delete(:type); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::OriginalType) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::OriginalType.apply(x)))
                @data = HttpClient::Preconditions.assert_class('data', opts.delete(:data), String)
              end
            ...
            class Subscription
              ...
              def initialize(incoming={})
                ...
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Organization) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(x))
                @user = (x = opts.delete(:user); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::User) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::User.new(x))
                @publication = (x = opts.delete(:publication); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Publication) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Publication.apply(x))
                @audit = (x = opts.delete(:audit); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Audit) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Audit.new(x))
              end
            ...
            class Version
              ...
              def initialize(incoming={})
                ...
                @application = (x = opts.delete(:application); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Reference) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Reference.new(x))
                @version = HttpClient::Preconditions.assert_class('version', opts.delete(:version), String)
                @original = (x = opts.delete(:original); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Original) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Original.new(x)))
                @service = (x = opts.delete(:service); x.is_a?(::Com::Gilt::Apidoc::Spec::V0::Models::Service) ? x : ::Com::Gilt::Apidoc::Spec::V0::Models::Service.new(x))
                @audit = (x = opts.delete(:audit); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Audit) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Audit.new(x))
              end
            ...
            class VersionForm
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @original_form = (x = opts.delete(:original_form); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::OriginalForm) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::OriginalForm.new(x))
                @visibility = (x = opts.delete(:visibility); x.nil? ? nil : (x = x; x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(x)))
              end
            ...
            class Watch
              ...
              def initialize(incoming={})
                ...
                @user = (x = opts.delete(:user); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::User) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::User.new(x))
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Organization) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(x))
                @application = (x = opts.delete(:application); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Application) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Application.new(x))
                @audit = (x = opts.delete(:audit); x.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Audit) ? x : ::Com::Gilt::Apidoc::Api::V0::Models::Audit.new(x))
              end
