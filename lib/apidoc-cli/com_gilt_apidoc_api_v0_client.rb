...
# apidoc:0.9.1 http://localhost:9000/gilt/apidoc-api/0.8.28/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              USER_AGENT = 'apidoc:0.9.1 http://localhost:9000/gilt/apidoc-api/0.8.28/ruby_client' unless defined?(Constants::USER_AGENT)
          ...
          module Models
            ...
            class Generator
              ...
              attr_reader :guid, :key, :uri, :name, :language, :description, :visibility
