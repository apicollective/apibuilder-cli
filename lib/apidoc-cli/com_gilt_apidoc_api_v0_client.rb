...
# apidoc:0.9.0 http://localhost:9000/gilt/apidoc-api/0.8.28/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              USER_AGENT = 'apidoc:0.9.0 http://localhost:9000/gilt/apidoc-api/0.8.28/ruby_client' unless defined?(Constants::USER_AGENT)
              VERSION = '0.8.28' unless defined?(Constants::VERSION)
            ...
            def applications
              @applications ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Applications.new(self)
            end

            def code
              @code ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Code.new(self)
            end

            def domains
              @domains ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Domains.new(self)
            end

            def email_verification_confirmation_forms
              @email_verification_confirmation_forms ||= ::Com::Gilt::Apidoc::Api::V0::Clients::EmailVerificationConfirmationForms.new(self)
            end

            def generators
              @generators ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Generators.new(self)
            end

            def healthchecks
              @healthchecks ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Healthchecks.new(self)
            end

            def memberships
              @memberships ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Memberships.new(self)
            end

            def membership_requests
              @membership_requests ||= ::Com::Gilt::Apidoc::Api::V0::Clients::MembershipRequests.new(self)
            end

            def organizations
              @organizations ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Organizations.new(self)
            end

            def password_resets
              @password_resets ||= ::Com::Gilt::Apidoc::Api::V0::Clients::PasswordResets.new(self)
            end

            def password_reset_requests
              @password_reset_requests ||= ::Com::Gilt::Apidoc::Api::V0::Clients::PasswordResetRequests.new(self)
            end

            def subscriptions
              @subscriptions ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Subscriptions.new(self)
            end

            def tokens
              @tokens ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Tokens.new(self)
            end

            def users
              @users ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Users.new(self)
            end

            def validations
              @validations ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Validations.new(self)
            end

            def versions
              @versions ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Versions.new(self)
            end

            def watches
              @watches ||= ::Com::Gilt::Apidoc::Api::V0::Clients::Watches.new(self)
            end
          end
          ...
          module Clients
            ...
            class Applications
              ...
              def initialize(client)
                @client = HttpClient::Preconditions.assert_class('client', client, ::Com::Gilt::Apidoc::Api::V0::Client)
              end
              ...
              def get_by_org_key(org_key, incoming={})
                ...
                query = {
                  ...
                  :limit => HttpClient::Preconditions.assert_class('limit', opts.delete(:limit) || 25, Integer),
                  :offset => HttpClient::Preconditions.assert_class('offset', opts.delete(:offset) || 0, Integer)
                }.delete_if { |k, v| v.nil? }
                @client.request("/#{CGI.escape(org_key)}").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Application.new(hash) }
              end

              # Create an application.
              def post_by_org_key(org_key, application_form)
                HttpClient::Preconditions.assert_class('org_key', org_key, String)
                HttpClient::Preconditions.assert_class('application_form', application_form, ::Com::Gilt::Apidoc::Api::V0::Models::ApplicationForm)
                @client.request("/#{CGI.escape(org_key)}").with_json(application_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Application.new(hash) }
              end
              ...
              def put_by_org_key_and_application_key(org_key, application_key, application_form)
                ...
                HttpClient::Preconditions.assert_class('application_form', application_form, ::Com::Gilt::Apidoc::Api::V0::Models::ApplicationForm)
                @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}").with_json(application_form.to_json).put { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Application.new(hash) }
              end
              ...
              def delete_by_org_key_and_application_key(org_key, application_key)
                HttpClient::Preconditions.assert_class('org_key', org_key, String)
                HttpClient::Preconditions.assert_class('application_key', application_key, String)
                @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class Code
              ...
              def get_by_org_key_and_application_key_and_version_and_generator_key(org_key, application_key, version, generator_key)
                ...
                @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}/#{CGI.escape(version)}/#{CGI.escape(generator_key)}").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Code.new(hash) }
              end
            ...
            class Domains
              ...
              def post_by_org_key(org_key, domain)
                HttpClient::Preconditions.assert_class('org_key', org_key, String)
                HttpClient::Preconditions.assert_class('domain', domain, ::Com::Gilt::Apidoc::Api::V0::Models::Domain)
                @client.request("/domains/#{CGI.escape(org_key)}").with_json(domain.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Domain.new(hash) }
              end
              ...
              def delete_by_org_key_and_name(org_key, name)
                ...
                @client.request("/domains/#{CGI.escape(org_key)}/#{CGI.escape(name)}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class EmailVerificationConfirmationForms
              ...
              def post_email_verification_confirmations(email_verification_confirmation_form)
                HttpClient::Preconditions.assert_class('email_verification_confirmation_form', email_verification_confirmation_form, ::Com::Gilt::Apidoc::Api::V0::Models::EmailVerificationConfirmationForm)
                @client.request("/email_verification_confirmations").with_json(email_verification_confirmation_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class Generators
              ...
              def get(incoming={})
                ...
                query = {
                  ...
                  :key => HttpClient::Preconditions.assert_class_or_nil('key', opts.delete(:key), String),
                  :limit => HttpClient::Preconditions.assert_class('limit', opts.delete(:limit) || 100, Integer),
                  :offset => HttpClient::Preconditions.assert_class('offset', opts.delete(:offset) || 0, Integer)
                }.delete_if { |k, v| v.nil? }
                @client.request("/generators").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Generator.new(hash) }
              end

              def get_by_key(key)
                HttpClient::Preconditions.assert_class('key', key, String)
                @client.request("/generators/#{CGI.escape(key)}").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Generator.new(hash) }
              end

              def post(generator_create_form)
                HttpClient::Preconditions.assert_class('generator_create_form', generator_create_form, ::Com::Gilt::Apidoc::Api::V0::Models::GeneratorCreateForm)
                @client.request("/generators").with_json(generator_create_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Generator.new(hash) }
              end

              def put_by_key(key, generator_update_form)
                HttpClient::Preconditions.assert_class('key', key, String)
                HttpClient::Preconditions.assert_class('generator_update_form', generator_update_form, ::Com::Gilt::Apidoc::Api::V0::Models::GeneratorUpdateForm)
                @client.request("/generators/#{CGI.escape(key)}").with_json(generator_update_form.to_json).put { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Generator.new(hash) }
              end

              # Deletes a generator.
              def delete_by_key(key)
                HttpClient::Preconditions.assert_class('key', key, String)
                @client.request("/generators/#{CGI.escape(key)}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class Healthchecks
              ...
              def get_internal_and_healthcheck
                @client.request("/_internal_/healthcheck").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Healthcheck.new(hash) }
              end

              def get_internal_and_migrate
                @client.request("/_internal_/migrate").get.inject({}) { |hash, o| hash[o[0]] = o[1].nil? ? nil : ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash); hash }
              end
            ...
            class Memberships
              ...
              def get(incoming={})
                ...
                @client.request("/memberships").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Membership.new(hash) }
              end

              def get_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/memberships/#{guid}").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Membership.new(hash) }
              end

              def delete_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/memberships/#{guid}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class MembershipRequests
              ...
              def get(incoming={})
                ...
                @client.request("/membership_requests").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::MembershipRequest.new(hash) }
              end

              # Create a membership request
              def post(hash)
                HttpClient::Preconditions.assert_class('hash', hash, Hash)
                @client.request("/membership_requests").with_json(hash.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::MembershipRequest.new(hash) }
              end
              ...
              def post_accept_by_guid(guid, hash)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                HttpClient::Preconditions.assert_class('hash', hash, Hash)
                @client.request("/membership_requests/#{guid}/accept").with_json(hash.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
              ...
              def post_decline_by_guid(guid, hash)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                HttpClient::Preconditions.assert_class('hash', hash, Hash)
                @client.request("/membership_requests/#{guid}/decline").with_json(hash.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class Organizations
              ...
              def get(incoming={})
                ...
                @client.request("/organizations").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(hash) }
              end

              # Returns the organization with this key.
              def get_by_key(key)
                HttpClient::Preconditions.assert_class('key', key, String)
                @client.request("/organizations/#{CGI.escape(key)}").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(hash) }
              end

              # Create a new organization.
              def post(organization_form)
                HttpClient::Preconditions.assert_class('organization_form', organization_form, ::Com::Gilt::Apidoc::Api::V0::Models::OrganizationForm)
                @client.request("/organizations").with_json(organization_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(hash) }
              end
              ...
              def put_by_key(key, organization_form)
                HttpClient::Preconditions.assert_class('key', key, String)
                HttpClient::Preconditions.assert_class('organization_form', organization_form, ::Com::Gilt::Apidoc::Api::V0::Models::OrganizationForm)
                @client.request("/organizations/#{CGI.escape(key)}").with_json(organization_form.to_json).put { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(hash) }
              end

              # Deletes an organization and all of its associated applications.
              def delete_by_key(key)
                HttpClient::Preconditions.assert_class('key', key, String)
                @client.request("/organizations/#{CGI.escape(key)}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class PasswordResets
              ...
              def post(password_reset)
                HttpClient::Preconditions.assert_class('password_reset', password_reset, ::Com::Gilt::Apidoc::Api::V0::Models::PasswordReset)
                @client.request("/password_resets").with_json(password_reset.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::PasswordResetSuccess.new(hash) }
              end
            ...
            class PasswordResetRequests
              ...
              def post(password_reset_request)
                HttpClient::Preconditions.assert_class('password_reset_request', password_reset_request, ::Com::Gilt::Apidoc::Api::V0::Models::PasswordResetRequest)
                @client.request("/password_reset_requests").with_json(password_reset_request.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class Subscriptions
              ...
              def get(incoming={})
                ...
                query = {
                  ...
                  :user_guid => HttpClient::Preconditions.assert_class_or_nil('user_guid', HttpClient::Helper.to_uuid(opts.delete(:user_guid)), String),
                  :publication => HttpClient::Preconditions.assert_class_or_nil('publication', opts[:publication].nil? ? nil : (opts[:publication].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Publication) ? opts.delete(:publication) : ::Com::Gilt::Apidoc::Api::V0::Models::Publication.apply(opts.delete(:publication))), ::Com::Gilt::Apidoc::Api::V0::Models::Publication),
                  :limit => HttpClient::Preconditions.assert_class('limit', opts.delete(:limit) || 25, Integer),
                  :offset => HttpClient::Preconditions.assert_class('offset', opts.delete(:offset) || 0, Integer)
                }.delete_if { |k, v| v.nil? }
                @client.request("/subscriptions").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Subscription.new(hash) }
              end

              # Returns information about a specific subscription.
              def get_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/subscriptions/#{guid}").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Subscription.new(hash) }
              end

              # Create a new subscription.
              def post(subscription_form)
                HttpClient::Preconditions.assert_class('subscription_form', subscription_form, ::Com::Gilt::Apidoc::Api::V0::Models::SubscriptionForm)
                @client.request("/subscriptions").with_json(subscription_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Subscription.new(hash) }
              end

              def delete_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/subscriptions/#{guid}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class Tokens
              ...
              def get_users_by_user_guid(user_guid, incoming={})
                ...
                @client.request("/tokens/users/#{user_guid}").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Token.new(hash) }
              end

              # Used to fetch the clear text token.
              def get_cleartext_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/tokens/#{guid}/cleartext").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::CleartextToken.new(hash) }
              end

              # Create a new API token for this user
              def post(token_form)
                HttpClient::Preconditions.assert_class('token_form', token_form, ::Com::Gilt::Apidoc::Api::V0::Models::TokenForm)
                @client.request("/tokens").with_json(token_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Token.new(hash) }
              end

              def delete_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/tokens/#{guid}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class Users
              ...
              def get(incoming={})
                ...
                @client.request("/users").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::User.new(hash) }
              end

              # Returns information about the user with this guid.
              def get_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/users/#{guid}").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::User.new(hash) }
              end
              ...
              def post_authenticate(hash)
                HttpClient::Preconditions.assert_class('hash', hash, Hash)
                @client.request("/users/authenticate").with_json(hash.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::User.new(hash) }
              end

              # Create a new user.
              def post(user_form)
                HttpClient::Preconditions.assert_class('user_form', user_form, ::Com::Gilt::Apidoc::Api::V0::Models::UserForm)
                @client.request("/users").with_json(user_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::User.new(hash) }
              end

              # Updates information about the user with the specified guid.
              def put_by_guid(guid, user_update_form)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                HttpClient::Preconditions.assert_class('user_update_form', user_update_form, ::Com::Gilt::Apidoc::Api::V0::Models::UserUpdateForm)
                @client.request("/users/#{guid}").with_json(user_update_form.to_json).put { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::User.new(hash) }
              end
            ...
            class Validations
              ...
              def post(value)
                ...
                @client.request("/validations").with_body(value).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Validation.new(hash) }
              end
            ...
            class Versions
              ...
              def get_by_org_key_and_application_key(org_key, application_key, incoming={})
                ...
                @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Version.new(hash) }
              end
              ...
              def get_by_org_key_and_application_key_and_version(org_key, application_key, version)
                ...
                HttpClient::Preconditions.assert_class('application_key', application_key, String)
                HttpClient::Preconditions.assert_class('version', version, String)
                @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}/#{CGI.escape(version)}").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Version.new(hash) }
              end
              ...
              def post_by_org_key_and_version(org_key, version, version_form)
                HttpClient::Preconditions.assert_class('org_key', org_key, String)
                HttpClient::Preconditions.assert_class('version', version, String)
                HttpClient::Preconditions.assert_class('version_form', version_form, ::Com::Gilt::Apidoc::Api::V0::Models::VersionForm)
                @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(version)}").with_json(version_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Version.new(hash) }
              end
              ...
              def put_by_org_key_and_application_key_and_version(org_key, application_key, version, version_form)
                ...
                HttpClient::Preconditions.assert_class('version', version, String)
                HttpClient::Preconditions.assert_class('version_form', version_form, ::Com::Gilt::Apidoc::Api::V0::Models::VersionForm)
                @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}/#{CGI.escape(version)}").with_json(version_form.to_json).put { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Version.new(hash) }
              end
              ...
              def delete_by_org_key_and_application_key_and_version(org_key, application_key, version)
                ...
                HttpClient::Preconditions.assert_class('application_key', application_key, String)
                HttpClient::Preconditions.assert_class('version', version, String)
                @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}/#{CGI.escape(version)}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
            ...
            class Watches
              ...
              def get(incoming={})
                ...
                @client.request("/watches").with_query(query).get.map { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Watch.new(hash) }
              end

              # Returns information about a specific watch.
              def get_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/watches/#{guid}").get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Watch.new(hash) }
              end
              ...
              def get_check(incoming={})
                ...
                @client.request("/watches/check").with_query(query).get { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end

              # Create a new watch.
              def post(watch_form)
                HttpClient::Preconditions.assert_class('watch_form', watch_form, ::Com::Gilt::Apidoc::Api::V0::Models::WatchForm)
                @client.request("/watches").with_json(watch_form.to_json).post { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Watch.new(hash) }
              end

              def delete_by_guid(guid)
                HttpClient::Preconditions.assert_class('guid', guid, String)
                @client.request("/watches/#{guid}").delete { |hash| ::Com::Gilt::Apidoc::Api::V0::Models::Value.new(hash) }
              end
          ...
          module Models
            ...
            class Audit
              ...
              def initialize(incoming={})
                ...
                @created_by = HttpClient::Preconditions.assert_class('created_by', opts[:created_by].nil? ? nil : (opts[:created_by].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::ReferenceGuid) ? opts.delete(:created_by) : ::Com::Gilt::Apidoc::Api::V0::Models::ReferenceGuid.new(opts.delete(:created_by))), ::Com::Gilt::Apidoc::Api::V0::Models::ReferenceGuid)
                ...
                @updated_by = HttpClient::Preconditions.assert_class('updated_by', opts[:updated_by].nil? ? nil : (opts[:updated_by].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::ReferenceGuid) ? opts.delete(:updated_by) : ::Com::Gilt::Apidoc::Api::V0::Models::ReferenceGuid.new(opts.delete(:updated_by))), ::Com::Gilt::Apidoc::Api::V0::Models::ReferenceGuid)
              end
            ...
            class Code
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @generator = HttpClient::Preconditions.assert_class('generator', opts[:generator].nil? ? nil : (opts[:generator].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Generator) ? opts.delete(:generator) : ::Com::Gilt::Apidoc::Api::V0::Models::Generator.new(opts.delete(:generator))), ::Com::Gilt::Apidoc::Api::V0::Models::Generator)
            ...
            class Generator
              ...
              def initialize(incoming={})
                ...
                @description = HttpClient::Preconditions.assert_class_or_nil('description', opts.delete(:description), String)
                @visibility = HttpClient::Preconditions.assert_class('visibility', opts[:visibility].nil? ? nil : (opts[:visibility].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? opts.delete(:visibility) : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(opts.delete(:visibility))), ::Com::Gilt::Apidoc::Api::V0::Models::Visibility)
                @owner = HttpClient::Preconditions.assert_class('owner', opts[:owner].nil? ? nil : (opts[:owner].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::User) ? opts.delete(:owner) : ::Com::Gilt::Apidoc::Api::V0::Models::User.new(opts.delete(:owner))), ::Com::Gilt::Apidoc::Api::V0::Models::User)
            ...
            class GeneratorUpdateForm
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @visibility = HttpClient::Preconditions.assert_class_or_nil('visibility', opts[:visibility].nil? ? nil : (opts[:visibility].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? opts.delete(:visibility) : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(opts.delete(:visibility))), ::Com::Gilt::Apidoc::Api::V0::Models::Visibility)
            ...
            class Membership
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @guid = HttpClient::Preconditions.assert_class('guid', HttpClient::Helper.to_uuid(opts.delete(:guid)), String)
                @user = HttpClient::Preconditions.assert_class('user', opts[:user].nil? ? nil : (opts[:user].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::User) ? opts.delete(:user) : ::Com::Gilt::Apidoc::Api::V0::Models::User.new(opts.delete(:user))), ::Com::Gilt::Apidoc::Api::V0::Models::User)
                @organization = HttpClient::Preconditions.assert_class('organization', opts[:organization].nil? ? nil : (opts[:organization].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Organization) ? opts.delete(:organization) : ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(opts.delete(:organization))), ::Com::Gilt::Apidoc::Api::V0::Models::Organization)
            ...
            class Organization
              ...
              def initialize(incoming={})
                ...
                @visibility = HttpClient::Preconditions.assert_class('visibility', opts[:visibility].nil? ? nil : (opts[:visibility].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? opts.delete(:visibility) : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(opts.delete(:visibility))), ::Com::Gilt::Apidoc::Api::V0::Models::Visibility)
                @domains = HttpClient::Preconditions.assert_class('domains', opts.delete(:domains) || [], Array).map { |el| el.nil? ? nil : (el.is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Domain) ? el : ::Com::Gilt::Apidoc::Api::V0::Models::Domain.new(el)) }
              end
            ...
            class OrganizationForm
              ...
              def initialize(incoming={})
                ...
                @namespace = HttpClient::Preconditions.assert_class('namespace', opts.delete(:namespace), String)
                @visibility = HttpClient::Preconditions.assert_class('visibility', opts[:visibility].nil? ? nil : (opts[:visibility].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? opts.delete(:visibility) : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(opts.delete(:visibility))), ::Com::Gilt::Apidoc::Api::V0::Models::Visibility)
                @domains = (x = opts.delete(:domains); x.nil? ? nil : x.map { |v| HttpClient::Preconditions.assert_class('domains', v, String)})
              end
            ...
            class Original
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @type = HttpClient::Preconditions.assert_class('type', opts[:type].nil? ? nil : (opts[:type].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::OriginalType) ? opts.delete(:type) : ::Com::Gilt::Apidoc::Api::V0::Models::OriginalType.apply(opts.delete(:type))), ::Com::Gilt::Apidoc::Api::V0::Models::OriginalType)
            ...
            class OriginalForm
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @type = HttpClient::Preconditions.assert_class_or_nil('type', opts[:type].nil? ? nil : (opts[:type].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::OriginalType) ? opts.delete(:type) : ::Com::Gilt::Apidoc::Api::V0::Models::OriginalType.apply(opts.delete(:type))), ::Com::Gilt::Apidoc::Api::V0::Models::OriginalType)
                @data = HttpClient::Preconditions.assert_class('data', opts.delete(:data), String)
              end
            ...
            class Subscription
              ...
              def initialize(incoming={})
                ...
                @organization = HttpClient::Preconditions.assert_class('organization', opts[:organization].nil? ? nil : (opts[:organization].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Organization) ? opts.delete(:organization) : ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(opts.delete(:organization))), ::Com::Gilt::Apidoc::Api::V0::Models::Organization)
                @user = HttpClient::Preconditions.assert_class('user', opts[:user].nil? ? nil : (opts[:user].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::User) ? opts.delete(:user) : ::Com::Gilt::Apidoc::Api::V0::Models::User.new(opts.delete(:user))), ::Com::Gilt::Apidoc::Api::V0::Models::User)
                @publication = HttpClient::Preconditions.assert_class('publication', opts[:publication].nil? ? nil : (opts[:publication].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Publication) ? opts.delete(:publication) : ::Com::Gilt::Apidoc::Api::V0::Models::Publication.apply(opts.delete(:publication))), ::Com::Gilt::Apidoc::Api::V0::Models::Publication)
              end
            ...
            class Token
              ...
              def initialize(incoming={})
                ...
                @description = HttpClient::Preconditions.assert_class_or_nil('description', opts.delete(:description), String)
                @audit = HttpClient::Preconditions.assert_class('audit', opts[:audit].nil? ? nil : (opts[:audit].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Audit) ? opts.delete(:audit) : ::Com::Gilt::Apidoc::Api::V0::Models::Audit.new(opts.delete(:audit))), ::Com::Gilt::Apidoc::Api::V0::Models::Audit)
              end
            ...
            class User
              ...
              attr_reader :guid, :email, :nickname, :name
            ...
            class UserForm
              ...
              def initialize(incoming={})
                ...
                @email = HttpClient::Preconditions.assert_class('email', opts.delete(:email), String)
                @password = HttpClient::Preconditions.assert_class('password', opts.delete(:password), String)
                @nickname = HttpClient::Preconditions.assert_class_or_nil('nickname', opts.delete(:nickname), String)
                @name = HttpClient::Preconditions.assert_class_or_nil('name', opts.delete(:name), String)
              end
            ...
            class Validation
              ...
              def initialize(incoming={})
                ...
                @errors = HttpClient::Preconditions.assert_class('errors', opts.delete(:errors) || [], Array).map { |v| HttpClient::Preconditions.assert_class('errors', v, String)}
              end
            ...
            class Version
              ...
              def initialize(incoming={})
                ...
                @guid = HttpClient::Preconditions.assert_class('guid', HttpClient::Helper.to_uuid(opts.delete(:guid)), String)
                @organization = HttpClient::Preconditions.assert_class('organization', opts[:organization].nil? ? nil : (opts[:organization].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Reference) ? opts.delete(:organization) : ::Com::Gilt::Apidoc::Api::V0::Models::Reference.new(opts.delete(:organization))), ::Com::Gilt::Apidoc::Api::V0::Models::Reference)
                @application = HttpClient::Preconditions.assert_class('application', opts[:application].nil? ? nil : (opts[:application].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Reference) ? opts.delete(:application) : ::Com::Gilt::Apidoc::Api::V0::Models::Reference.new(opts.delete(:application))), ::Com::Gilt::Apidoc::Api::V0::Models::Reference)
                @version = HttpClient::Preconditions.assert_class('version', opts.delete(:version), String)
                @original = HttpClient::Preconditions.assert_class_or_nil('original', opts[:original].nil? ? nil : (opts[:original].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Original) ? opts.delete(:original) : ::Com::Gilt::Apidoc::Api::V0::Models::Original.new(opts.delete(:original))), ::Com::Gilt::Apidoc::Api::V0::Models::Original)
            ...
            class VersionForm
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @original_form = HttpClient::Preconditions.assert_class('original_form', opts[:original_form].nil? ? nil : (opts[:original_form].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::OriginalForm) ? opts.delete(:original_form) : ::Com::Gilt::Apidoc::Api::V0::Models::OriginalForm.new(opts.delete(:original_form))), ::Com::Gilt::Apidoc::Api::V0::Models::OriginalForm)
                @visibility = HttpClient::Preconditions.assert_class_or_nil('visibility', opts[:visibility].nil? ? nil : (opts[:visibility].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Visibility) ? opts.delete(:visibility) : ::Com::Gilt::Apidoc::Api::V0::Models::Visibility.apply(opts.delete(:visibility))), ::Com::Gilt::Apidoc::Api::V0::Models::Visibility)
              end
              ...
              def to_hash
                {
                  :original_form => original_form.nil? ? nil : original_form.to_hash,
                  :visibility => visibility.nil? ? nil : visibility.value
                }
              end
            ...
            class Watch
              ...
              def initialize(incoming={})
                ...
                @user = HttpClient::Preconditions.assert_class('user', opts[:user].nil? ? nil : (opts[:user].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::User) ? opts.delete(:user) : ::Com::Gilt::Apidoc::Api::V0::Models::User.new(opts.delete(:user))), ::Com::Gilt::Apidoc::Api::V0::Models::User)
                @organization = HttpClient::Preconditions.assert_class('organization', opts[:organization].nil? ? nil : (opts[:organization].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Organization) ? opts.delete(:organization) : ::Com::Gilt::Apidoc::Api::V0::Models::Organization.new(opts.delete(:organization))), ::Com::Gilt::Apidoc::Api::V0::Models::Organization)
                @application = HttpClient::Preconditions.assert_class('application', opts[:application].nil? ? nil : (opts[:application].is_a?(::Com::Gilt::Apidoc::Api::V0::Models::Application) ? opts.delete(:application) : ::Com::Gilt::Apidoc::Api::V0::Models::Application.new(opts.delete(:application))), ::Com::Gilt::Apidoc::Api::V0::Models::Application)
              end
