...
# apidoc:0.11.6 http://www.apidoc.me/bryzek/apidoc-spec/0.11.6/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              NAMESPACE = 'com.bryzek.apidoc.spec.v0' unless defined?(Constants::NAMESPACE)
              USER_AGENT = 'apidoc:0.11.6 http://www.apidoc.me/bryzek/apidoc-spec/0.11.6/ruby_client' unless defined?(Constants::USER_AGENT)
              VERSION = '0.11.6' unless defined?(Constants::VERSION)
          ...
          module Models
              ...
              def ResponseCode.from_json(hash)
                ...
                hash.map do |union_type_name, data|
                  case union_type_name
                    ...
                    else ResponseCodeUndefinedType.new(:name => union_type_name)
                  end
                end.first
              end
            ...
            class Body
              ...
              attr_reader :type, :description, :deprecation

              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @type = HttpClient::Preconditions.assert_class('type', opts.delete(:type), String)
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
              end
            ...
            class Enum
              ...
              attr_reader :name, :plural, :description, :deprecation, :values
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @values = HttpClient::Preconditions.assert_class('values', opts.delete(:values), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::EnumValue) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::EnumValue.new(x)) }
              end
            ...
            class Field
              ...
              attr_reader :name, :type, :description, :deprecation, :default, :required, :minimum, :maximum, :example
            ...
            class Header
              ...
              attr_reader :name, :type, :description, :deprecation, :required, :default
            ...
            class Import
              ...
              def initialize(incoming={})
                ...
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Organization) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Organization.new(x))
                @application = (x = opts.delete(:application); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Application) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Application.new(x))
                @version = HttpClient::Preconditions.assert_class('version', opts.delete(:version), String)
            ...
            class Info
              ...
              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @license = (x = opts.delete(:license); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::License) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::License.new(x)))
                @contact = (x = opts.delete(:contact); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Contact) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Contact.new(x)))
              end
            ...
            class Model
              ...
              attr_reader :name, :plural, :description, :deprecation, :fields
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @fields = HttpClient::Preconditions.assert_class('fields', opts.delete(:fields), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Field) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Field.new(x)) }
              end
            ...
            class Operation
              ...
              attr_reader :method, :path, :description, :deprecation, :body, :parameters, :responses

              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @method = (x = opts.delete(:method); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Method) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Method.apply(x))
                @path = HttpClient::Preconditions.assert_class('path', opts.delete(:path), String)
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @body = (x = opts.delete(:body); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Body) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Body.new(x)))
                @parameters = HttpClient::Preconditions.assert_class('parameters', (x = opts.delete(:parameters); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Parameter) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Parameter.new(x)) }
                @responses = HttpClient::Preconditions.assert_class('responses', (x = opts.delete(:responses); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Response) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Response.new(x)) }
              end
            ...
            class Parameter
              ...
              def initialize(incoming={})
                ...
                @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
                @type = HttpClient::Preconditions.assert_class('type', opts.delete(:type), String)
                @location = (x = opts.delete(:location); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::ParameterLocation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::ParameterLocation.apply(x))
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @required = HttpClient::Preconditions.assert_boolean('required', opts.delete(:required))
                @default = (x = opts.delete(:default); x.nil? ? nil : HttpClient::Preconditions.assert_class('default', x, String))
            ...
            class Resource
              ...
              attr_reader :type, :plural, :path, :description, :deprecation, :operations
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @operations = HttpClient::Preconditions.assert_class('operations', opts.delete(:operations), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Operation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Operation.new(x)) }
              end
            ...
            class Response
              ...
              attr_reader :code, :type, :description, :deprecation

              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @code = (x = opts.delete(:code); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::ResponseCode) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::ResponseCode.from_json(x))
                @type = HttpClient::Preconditions.assert_class('type', opts.delete(:type), String)
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
              end
            ...
            class Service
              ...
              attr_reader :apidoc, :name, :organization, :application, :namespace, :version, :base_url, :description, :info, :headers, :imports, :enums, :unions, :models, :resources

              def initialize(incoming={})
                opts = HttpClient::Helper.symbolize_keys(incoming)
                @apidoc = (x = opts.delete(:apidoc); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Apidoc) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Apidoc.new(x))
                @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
                @organization = (x = opts.delete(:organization); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Organization) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Organization.new(x))
                @application = (x = opts.delete(:application); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Application) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Application.new(x))
                @namespace = HttpClient::Preconditions.assert_class('namespace', opts.delete(:namespace), String)
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @info = (x = opts.delete(:info); x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Info) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Info.new(x))
                @headers = HttpClient::Preconditions.assert_class('headers', (x = opts.delete(:headers); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Header) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Header.new(x)) }
                @imports = HttpClient::Preconditions.assert_class('imports', (x = opts.delete(:imports); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Import) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Import.new(x)) }
                @enums = HttpClient::Preconditions.assert_class('enums', (x = opts.delete(:enums); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Enum) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Enum.new(x)) }
                @unions = HttpClient::Preconditions.assert_class('unions', (x = opts.delete(:unions); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Union) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Union.new(x)) }
                @models = HttpClient::Preconditions.assert_class('models', (x = opts.delete(:models); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Model) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Model.new(x)) }
                @resources = HttpClient::Preconditions.assert_class('resources', (x = opts.delete(:resources); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Resource) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Resource.new(x)) }
              end
            ...
            class Union
              ...
              attr_reader :name, :plural, :discriminator, :description, :deprecation, :types
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @types = HttpClient::Preconditions.assert_class('types', opts.delete(:types), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::UnionType) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::UnionType.new(x)) }
              end
            ...
            class ResponseCodeIntegerWrapper < ResponseCode
              ...
              def initialize(incoming={})
                super(:name => ResponseCode::Types::RESPONSE_CODE_INTEGER_WRAPPER)
                opts = HttpClient::Helper.symbolize_keys(incoming)
