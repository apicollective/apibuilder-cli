...
# apidoc:0.11.52 http://www.apidoc.me/bryzek/apidoc-spec/0.11.54/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              USER_AGENT = 'apidoc:0.11.52 http://www.apidoc.me/bryzek/apidoc-spec/0.11.54/ruby_client' unless defined?(Constants::USER_AGENT)
              VERSION = '0.11.54' unless defined?(Constants::VERSION)
          ...
          module Models
            ...
            class ResponseCode
              ...
              def initialize(incoming={})
                ...
                HttpClient::Preconditions.require_keys(opts, [:__discriminator__], 'ResponseCode')
            ...
            class Body
              ...
              def initialize(incoming={})
                ...
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
                @attributes = HttpClient::Preconditions.assert_class('attributes', (x = opts.delete(:attributes); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Attribute) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Attribute.new(x)) }
              end
            ...
            class Response
              ...
              def initialize(incoming={})
                ...
                @type = HttpClient::Preconditions.assert_class('type', opts.delete(:type), String)
                @headers = (x = opts.delete(:headers); x.nil? ? nil : HttpClient::Preconditions.assert_class('headers', x, Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Header) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Header.new(x)) })
                @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
                @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation) ? x : ::Com::Bryzek::Apidoc::Spec::V0::Models::Deprecation.new(x)))
              end
