...
# apidoc:0.9.17 http://localhost:9000/gilt/apidoc-generator/0.9.16/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              USER_AGENT = 'apidoc:0.9.17 http://localhost:9000/gilt/apidoc-generator/0.9.16/ruby_client' unless defined?(Constants::USER_AGENT)
            ...
            def generators
              @generators ||= ::Com::Gilt::Apidoc::Generator::V0::Clients::Generators.new(self)
            end

            def healthchecks
              @healthchecks ||= ::Com::Gilt::Apidoc::Generator::V0::Clients::Healthchecks.new(self)
            end

            def invocations
              @invocations ||= ::Com::Gilt::Apidoc::Generator::V0::Clients::Invocations.new(self)
            end
          end
          ...
          module Clients
            ...
            class Generators
              ...
              def initialize(client)
                @client = HttpClient::Preconditions.assert_class('client', client, ::Com::Gilt::Apidoc::Generator::V0::Client)
              end
            ...
            class Healthchecks
              ...
              def get_internal_and_healthcheck
                ...
                ::Com::Gilt::Apidoc::Generator::V0::Models::Healthcheck.new(r)
              end
            ...
            class Invocations
              ...
              def post_by_key(key, invocation_form)
                HttpClient::Preconditions.assert_class('key', key, String)
                HttpClient::Preconditions.assert_class('invocation_form', invocation_form, ::Com::Gilt::Apidoc::Generator::V0::Models::InvocationForm)
                r = @client.request("/invocations/#{CGI.escape(key)}").with_json(invocation_form.to_json).post
                ::Com::Gilt::Apidoc::Generator::V0::Models::Invocation.new(r)
              end
