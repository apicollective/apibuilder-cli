...
# apidoc:0.11.51 http://localhost:9000/bryzek/apidoc-generator/0.11.52/ruby_client
        ...
        module V0
          ...
          class Client
            ...
            module Constants
              ...
              BASE_URL = 'http://www.apidoc.me' unless defined?(Constants::BASE_URL)
              NAMESPACE = 'com.bryzek.apidoc.generator.v0' unless defined?(Constants::NAMESPACE)
              USER_AGENT = 'apidoc:0.11.51 http://localhost:9000/bryzek/apidoc-generator/0.11.52/ruby_client' unless defined?(Constants::USER_AGENT)
          ...
          module Models
            ...
            class InvocationForm
              ...
              def initialize(incoming={})
                ...
                @attributes = HttpClient::Preconditions.assert_class('attributes', (x = opts.delete(:attributes); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Com::Bryzek::Apidoc::Generator::V0::Models::Attribute) ? x : ::Com::Bryzek::Apidoc::Generator::V0::Models::Attribute.new(x)) }
