...
# apidoc:0.8.15 http://localhost:9000/gilt/apidoc/0.8.15-29-g9f5c449/ruby_client
      ...
      module V0
        ...
        class Client
          ...
          module Constants
            ...
            USER_AGENT = 'apidoc:0.8.15 http://localhost:9000/gilt/apidoc/0.8.15-29-g9f5c449/ruby_client' unless defined?(Constants::USER_AGENT)
            VERSION = '0.8.15-29-g9f5c449' unless defined?(Constants::VERSION)
        ...
        module Clients
          ...
          class Users
            ...
            def put_by_guid(guid, user_update_form)
              HttpClient::Preconditions.assert_class('guid', guid, String)
              HttpClient::Preconditions.assert_class('user_update_form', user_update_form, ::Com::Gilt::Apidoc::V0::Models::UserUpdateForm)
              @client.request("/users/#{guid}").with_json(user_update_form.to_json).put { |hash| ::Com::Gilt::Apidoc::V0::Models::User.new(hash) }
            end
        ...
        module Models
          ...
          class Original
            ...
            def initialize(incoming={})
              opts = HttpClient::Helper.symbolize_keys(incoming)
              @type = HttpClient::Preconditions.assert_class('type', opts[:type].nil? ? nil : (opts[:type].is_a?(::Com::Gilt::Apidoc::V0::Models::OriginalType) ? opts.delete(:type) : ::Com::Gilt::Apidoc::V0::Models::OriginalType.apply(opts.delete(:type))), ::Com::Gilt::Apidoc::V0::Models::OriginalType)
          ...
          class OriginalForm
            ...
            def initialize(incoming={})
              opts = HttpClient::Helper.symbolize_keys(incoming)
              @type = HttpClient::Preconditions.assert_class_or_nil('type', opts[:type].nil? ? nil : (opts[:type].is_a?(::Com::Gilt::Apidoc::V0::Models::OriginalType) ? opts.delete(:type) : ::Com::Gilt::Apidoc::V0::Models::OriginalType.apply(opts.delete(:type))), ::Com::Gilt::Apidoc::V0::Models::OriginalType)
              @data = HttpClient::Preconditions.assert_class('data', opts.delete(:data), String)
            end
          ...
          class Version
            ...
            def initialize(incoming={})
              ...
              @original = HttpClient::Preconditions.assert_class_or_nil('original', opts[:original].nil? ? nil : (opts[:original].is_a?(::Com::Gilt::Apidoc::V0::Models::Original) ? opts.delete(:original) : ::Com::Gilt::Apidoc::V0::Models::Original.new(opts.delete(:original))), ::Com::Gilt::Apidoc::V0::Models::Original)
          ...
          class VersionForm
            ...
            def initialize(incoming={})
              opts = HttpClient::Helper.symbolize_keys(incoming)
              @original_form = HttpClient::Preconditions.assert_class('original_form', opts[:original_form].nil? ? nil : (opts[:original_form].is_a?(::Com::Gilt::Apidoc::V0::Models::OriginalForm) ? opts.delete(:original_form) : ::Com::Gilt::Apidoc::V0::Models::OriginalForm.new(opts.delete(:original_form))), ::Com::Gilt::Apidoc::V0::Models::OriginalForm)
              @visibility = HttpClient::Preconditions.assert_class_or_nil('visibility', opts[:visibility].nil? ? nil : (opts[:visibility].is_a?(::Com::Gilt::Apidoc::V0::Models::Visibility) ? opts.delete(:visibility) : ::Com::Gilt::Apidoc::V0::Models::Visibility.apply(opts.delete(:visibility))), ::Com::Gilt::Apidoc::V0::Models::Visibility)
            end
