...
# apibuilder:0.12.3 https://api.apibuilder.io/apicollective/apibuilder-api/0.12.1/ruby_client
      ...
      module V0
        ...
        class Client
          ...
          module Constants
            ...
            BASE_URL = 'http://api.apibuilder.io' unless defined?(Constants::BASE_URL)
            NAMESPACE = 'io.apibuilder.api.v0' unless defined?(Constants::NAMESPACE)
            USER_AGENT = 'apibuilder:0.12.3 https://api.apibuilder.io/apicollective/apibuilder-api/0.12.1/ruby_client' unless defined?(Constants::USER_AGENT)
        ...
        module Clients
          ...
          class Users
            ...
            def post_authenticate_github(hash)
              HttpClient::Preconditions.assert_class('hash', hash, Hash)
              r = @client.request("/users/authenticate_github").with_json(hash.to_json).post
              ::Io::Apibuilder::Api::V0::Models::Authentication.new(r)
            end
