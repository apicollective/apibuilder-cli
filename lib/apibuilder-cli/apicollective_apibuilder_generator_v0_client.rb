...
# apibuilder:0.12.3 https://api.apibuilder.io/apicollective/apibuilder-generator/0.12.1/ruby_client
      ...
      module V0
        ...
        class Client
          ...
          module Constants
            ...
            BASE_URL = 'http://www.apibuilder.io' unless defined?(Constants::BASE_URL)
            NAMESPACE = 'io.apibuilder.generator.v0' unless defined?(Constants::NAMESPACE)
            USER_AGENT = 'apibuilder:0.12.3 https://api.apibuilder.io/apicollective/apibuilder-generator/0.12.1/ruby_client' unless defined?(Constants::USER_AGENT)
