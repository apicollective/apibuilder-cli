...
load File.join(lib_dir, 'com_bryzek_apidoc_spec_v0_client.rb')
load File.join(lib_dir, 'com_bryzek_apidoc_generator_v0_client.rb')
load File.join(lib_dir, 'com_bryzek_apidoc_api_v0_client.rb')
