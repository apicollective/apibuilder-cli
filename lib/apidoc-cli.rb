...
load File.join(lib_dir, 'bryzek_apidoc_spec_v0_client.rb')
load File.join(lib_dir, 'bryzek_apidoc_common_v0_client.rb')
load File.join(lib_dir, 'bryzek_apidoc_generator_v0_client.rb')
load File.join(lib_dir, 'bryzek_apidoc_api_v0_client.rb')
