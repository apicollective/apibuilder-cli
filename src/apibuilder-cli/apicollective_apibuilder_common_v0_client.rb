...
# User agent: apibuilder localhost 9000/apicollective/apibuilder-common/latest/ruby_client
      ...
      module V0
        ...
        class Client
          ...
          module Constants
            ...
            USER_AGENT = 'apibuilder localhost 9000/apicollective/apibuilder-common/latest/ruby_client' unless defined?(Constants::USER_AGENT)
        ...
        module Models
          ...
          class MembershipRole
            ...
            # Returns the instance of MembershipRole for this value, creating a new instance for an unknown value
            def MembershipRole.apply(value)
              if value.instance_of?(MembershipRole)
                value
              else
                HttpClient::Preconditions.assert_class_or_nil('value', value, String)
                value.nil? ? nil : (from_string(value) || MembershipRole.new(value))
              end
            end

            # Returns the instance of MembershipRole for this value, or nil if not found
            def MembershipRole.from_string(value)
              HttpClient::Preconditions.assert_class('value', value, String)
              MembershipRole.ALL.find { |v| v.value == value }
            end

            def MembershipRole.ALL
              @@all ||= [MembershipRole.member, MembershipRole.admin]
            end

            def MembershipRole.member
              @@_member ||= MembershipRole.new('member')
            end

            def MembershipRole.admin
              @@_admin ||= MembershipRole.new('admin')
            end
