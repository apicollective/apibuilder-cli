...
# apibuilder 0.15.6 app.apibuilder.io/apicollective/apibuilder-spec/latest/ruby_client
      ...
      module V0
        ...
        class Client
          ...
          module Constants
            ...
            USER_AGENT = 'apibuilder 0.15.6 app.apibuilder.io/apicollective/apibuilder-spec/latest/ruby_client' unless defined?(Constants::USER_AGENT)
            VERSION = '0.15.4' unless defined?(Constants::VERSION)
