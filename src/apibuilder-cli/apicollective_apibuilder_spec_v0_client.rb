...
# User agent: apibuilder localhost 9000/apicollective/apibuilder-spec/latest/ruby_client
      ...
      module V0
        ...
        class Client
          ...
          module Constants
            ...
            USER_AGENT = 'apibuilder localhost 9000/apicollective/apibuilder-spec/latest/ruby_client' unless defined?(Constants::USER_AGENT)
        ...
        module Models
          ...
          class EnumValue
            ...
            attr_reader :name, :description, :deprecation, :attributes, :value
          ...
          class Import
            ...
            attr_reader :uri, :namespace, :organization, :application, :version, :enums, :interfaces, :unions, :models, :annotations
            ...
            def initialize(incoming={})
              ...
              @interfaces = HttpClient::Preconditions.assert_class('interfaces', (x = opts.delete(:interfaces); x.nil? ? [] : x), Array).map { |v| HttpClient::Preconditions.assert_class('interfaces', v, String) }
          ...
          class Interface
            ...
            def initialize(incoming={})
              opts = HttpClient::Helper.symbolize_keys(incoming)
              HttpClient::Preconditions.require_keys(opts, [:name, :plural, :fields], 'Interface')
              @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
              @plural = HttpClient::Preconditions.assert_class('plural', opts.delete(:plural), String)
              @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
              @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Io::Apibuilder::Spec::V0::Models::Deprecation) ? x : ::Io::Apibuilder::Spec::V0::Models::Deprecation.new(x)))
            ...
            def copy(incoming={})
              Interface.new(to_hash.merge(HttpClient::Helper.symbolize_keys(incoming)))
            end
          ...
          class Model
            ...
            attr_reader :name, :plural, :description, :deprecation, :fields, :attributes, :interfaces
          ...
          class Parameter
            ...
            attr_reader :name, :type, :location, :description, :deprecation, :required, :default, :minimum, :maximum, :example, :attributes
            ...
            def initialize(incoming={})
              ...
              @maximum = (x = opts.delete(:maximum); x.nil? ? nil : HttpClient::Preconditions.assert_class('maximum', x, Integer))
              @example = (x = opts.delete(:example); x.nil? ? nil : HttpClient::Preconditions.assert_class('example', x, String))
              @attributes = (x = opts.delete(:attributes); x.nil? ? nil : HttpClient::Preconditions.assert_class('attributes', x, Array).map { |v| (x = v; x.is_a?(::Io::Apibuilder::Spec::V0::Models::Attribute) ? x : ::Io::Apibuilder::Spec::V0::Models::Attribute.new(x)) })
            end
          ...
          class Response
            ...
            attr_reader :code, :type, :headers, :description, :deprecation, :attributes
          ...
          class Service
            ...
            attr_reader :apidoc, :name, :organization, :application, :namespace, :version, :base_url, :description, :info, :headers, :imports, :enums, :interfaces, :unions, :models, :resources, :attributes, :annotations

            def initialize(incoming={})
              opts = HttpClient::Helper.symbolize_keys(incoming)
              HttpClient::Preconditions.require_keys(opts, [:name, :organization, :application, :namespace, :version, :info], 'Service')
              @apidoc = (x = opts.delete(:apidoc); x.nil? ? nil : (x = x; x.is_a?(::Io::Apibuilder::Spec::V0::Models::Apidoc) ? x : ::Io::Apibuilder::Spec::V0::Models::Apidoc.new(x)))
              @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
              @organization = (x = opts.delete(:organization); x.is_a?(::Io::Apibuilder::Spec::V0::Models::Organization) ? x : ::Io::Apibuilder::Spec::V0::Models::Organization.new(x))
              @application = (x = opts.delete(:application); x.is_a?(::Io::Apibuilder::Spec::V0::Models::Application) ? x : ::Io::Apibuilder::Spec::V0::Models::Application.new(x))
              @namespace = HttpClient::Preconditions.assert_class('namespace', opts.delete(:namespace), String)
              ...
              @interfaces = HttpClient::Preconditions.assert_class('interfaces', (x = opts.delete(:interfaces); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Io::Apibuilder::Spec::V0::Models::Interface) ? x : ::Io::Apibuilder::Spec::V0::Models::Interface.new(x)) }
            ...
            def to_hash
              {
                :apidoc => apidoc.nil? ? nil : apidoc.to_hash,
                :name => name,
                :organization => organization.to_hash,
                :application => application.to_hash,
                :namespace => namespace,
                ...
                :interfaces => interfaces.map { |o| o.to_hash },
          ...
          class Union
            ...
            attr_reader :name, :plural, :discriminator, :description, :deprecation, :types, :attributes, :interfaces
          ...
          class UnionType
            ...
            attr_reader :type, :description, :deprecation, :fields, :attributes, :default, :discriminator_value
            ...
            def initialize(incoming={})
              ...
              @description = (x = opts.delete(:description); x.nil? ? nil : HttpClient::Preconditions.assert_class('description', x, String))
              @deprecation = (x = opts.delete(:deprecation); x.nil? ? nil : (x = x; x.is_a?(::Io::Apibuilder::Spec::V0::Models::Deprecation) ? x : ::Io::Apibuilder::Spec::V0::Models::Deprecation.new(x)))
              @fields = (x = opts.delete(:fields); x.nil? ? nil : HttpClient::Preconditions.assert_class('fields', x, Array).map { |v| (x = v; x.is_a?(::Io::Apibuilder::Spec::V0::Models::Field) ? x : ::Io::Apibuilder::Spec::V0::Models::Field.new(x)) })
              @attributes = HttpClient::Preconditions.assert_class('attributes', (x = opts.delete(:attributes); x.nil? ? [] : x), Array).map { |v| (x = v; x.is_a?(::Io::Apibuilder::Spec::V0::Models::Attribute) ? x : ::Io::Apibuilder::Spec::V0::Models::Attribute.new(x)) }
              @default = (x = opts.delete(:default); x.nil? ? nil : HttpClient::Preconditions.assert_boolean('default', x))
              @discriminator_value = (x = opts.delete(:discriminator_value); x.nil? ? nil : HttpClient::Preconditions.assert_class('discriminator_value', x, String))
            end
            ...
            def to_hash
              {
                ...
                :description => description,
                :deprecation => deprecation.nil? ? nil : deprecation.to_hash,
                :fields => fields.nil? ? nil : fields.map { |o| o.to_hash },
                :attributes => attributes.map { |o| o.to_hash },
                :default => default,
