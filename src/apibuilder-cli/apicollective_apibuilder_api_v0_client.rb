...
# User agent: apibuilder localhost 9000/apicollective/apibuilder-api/latest/ruby_client
      ...
      module V0
        ...
        class Client
          ...
          module Constants
            ...
            USER_AGENT = 'apibuilder localhost 9000/apicollective/apibuilder-api/latest/ruby_client' unless defined?(Constants::USER_AGENT)
            VERSION = '0.16.78' unless defined?(Constants::VERSION)
          ...
          class Memberships
            ...
            def get(incoming={})
              ...
              query = {
                ...
                :role => (x = opts.delete(:role); x.nil? ? nil : (x = x; x.is_a?(::Io::Apibuilder::Common::V0::Models::MembershipRole) ? x : ::Io::Apibuilder::Common::V0::Models::MembershipRole.apply(x)).value),
                :limit => HttpClient::Preconditions.assert_class('limit', (x = opts.delete(:limit); x.nil? ? 25 : x), Integer),
                :offset => HttpClient::Preconditions.assert_class('offset', (x = opts.delete(:offset); x.nil? ? 0 : x), Integer)
              }.delete_if { |k, v| v.nil? }
        ...
        module Models
          ...
          class Membership
            ...
            def initialize(incoming={})
              ...
              @role = (x = opts.delete(:role); x.is_a?(::Io::Apibuilder::Common::V0::Models::MembershipRole) ? x : ::Io::Apibuilder::Common::V0::Models::MembershipRole.apply(x))
              @audit = (x = opts.delete(:audit); x.is_a?(::Io::Apibuilder::Common::V0::Models::Audit) ? x : ::Io::Apibuilder::Common::V0::Models::Audit.new(x))
            end
